                    ...
                    <div className="footer">
                        ...
                        <Row>
                            ...
                            <div className="logo-wrapper widget">
                                <p><Link to="#">
                                    <img className="img-fluid"  src={require(`../../assets/images/logo2.png`)}   alt="logo" />
                                </Link></p>
                            </div>
                            <div className="text-content">
                                <p className="mb-3 mt-4">Electronic solutions is an electronics store that strives to always offer the best products at the best prices.</p>
                                <p className="mb-4">You will find everything you need in our store!.</p>
                            </div>
                            ...
                            <div className="footer-nav-menu widget mt-4 mt-lg-0">
                                ...
                                <div className="menu-useful-links-container">
                                <ul className="menu">
                                    <li className="menu-item active"><Link to="#">Repairs</Link></li>
                            ...
                            <div className="pgs-contact-widget widget mt-4 mt-lg-0">
                                ...
                                <ul>
                                    <li><i className="fa fa-map-marker" /><span>9001 Stockdale Hwy, CA 93311 </span></li>
                                    <li className="pgs-contact-email"><i className="fa fa-envelope-o" /><span>support@esolutions.com</span></li>
                            ...
                            <Row className="align-items-center">
                                ...
                                <Row>
                                    ...
                                    <div className="footer-content">
                                        Electronic Solutions Mobile app is Available now. Download it now on your favorite device and indulge in a seamless shopping experience.
                                    </div>
                                    </div>
                                </Row>
                                </Col>
                    ...
                    <div className="footer-widget">
                        ...
                        <div className="row align-items-center">
                            <Col md={6} className="float-left">
                                 <p> © Copyright 2019 <Link to="#">Electronic Solutions</Link> All Rights Reserved.</p>
                            </Col>
