        ...
        <Row className="section-ptb align-items-center">
            <Col md={6} className="order-md-1 mb-4 mb-md-0">
                <div className="single_image-wrapper">
                  <img src={require(`../assets/images/categories/default/about.jpg`)}   className="attachment-full img-fluid" alt />
                </div>
            </Col>
            <Col md={6}>
                ...
                <div className="section-title mb-4">
                  <h2 className="title text-left"> About Electronic Solutions</h2>
                <div className="text-wrapper">
                    <p>We are Electronic Solutions a company dedicated to our costumers and always willing to go the extra mile in our costumer service.</p>
                    { expandedDiv }
                 </div>
                 </div>
