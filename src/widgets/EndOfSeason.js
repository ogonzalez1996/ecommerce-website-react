    ...
    return (
        <Row className="section-ptb section-1 align-items-center">
            ...
            <div className="section-title text-md-right">
                <h2 className="title text-right"> End of Year Sale</h2>
            ...
            <div className="single_image-wrapper">
                <img src={require(`../assets/images/categories/default/galaxy.jpg`)} className="img-fluid attachment-full" alt="season-img1" />
            </div>
            ...
            <div className="single_image-wrapper">
                <img src={require(`../assets/images/categories/default/ipad-pro.jpg`)} className="img-fluid attachment-full" alt="season-img2" />
            </div>
            <Row className="single_image-content">
                <Col sm={3} className="col-2 px-0">
                ...
                <Col sm={9} className="col-10">
                <div className="text-wrapper">
                    <p className="text-dark">Tablets</p>
                </div>
                </Col>
            </Row>
            </Col>
            ...
            <div className="single_image-wrapper">
                <img src={require(`../assets/images/categories/default/surface.jpg`)} className="img-fluid attachment-full" alt="season-img2" />
            </div>
            <Row className="single_image-content">
                <Col sm={3} className="col-2 px-0">
                <div className="border-space border-space-dark" />
                ...
                <Col sm={9} className="col-10">
                <div className="text-wrapper">
                    <p className="text-dark">Laptops</p>
                </div>
                </Col>
            </Row>
            </Col>
